...
function ClientCredentialsType(options) {
  options = options || {};
...
util.inherits(ClientCredentialsType, AbstractGrantType);
...
ClientCredentialsType.prototype.getUserFromClient = function(client) {
...
ClientCredentialsType.prototype.saveToken = function(user, client, scope) {
  var fns = [
