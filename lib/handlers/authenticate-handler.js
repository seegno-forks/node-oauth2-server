...
AuthenticateHandler.prototype.handle = function(request, response) {
  ...
  if (!(response instanceof Response)) {
    throw new InvalidArgumentError('Invalid argument: `response` must be an instance of Request');
  }
...
AuthenticateHandler.prototype.verifyScope = function(token) {
  return Promise.try(this.model.verifyScope, [token, this.scope]).then(function(scope) {
    if (!scope) {
