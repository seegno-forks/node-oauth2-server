...
AuthorizeHandler.prototype.handle = function(request, response) {
  ...
  return Promise.all(fns)
    .bind(this)
    .spread(function(authorizationCode, expiresAt, client, scope, state, user) {
...
AuthorizeHandler.prototype.getUser = function(request) {
...
AuthorizeHandler.prototype.saveAuthorizationCode = function(authorizationCode, expiresAt, scope, client, user) {
  var code = {
